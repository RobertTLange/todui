...
mod tests {
    ...
    fn normalizes_url_at_prefix_and_plain_repo_forms() {
        assert_eq!(
            normalize_repo("https://github.com/SakanaAI/todui-keymove").unwrap(),
            "sakanaai/todui-keymove"
        );
        assert_eq!(
            normalize_repo("@SakanaAI/todui-keymove").unwrap(),
            "sakanaai/todui-keymove"
        );
        assert_eq!(
            normalize_repo("SakanaAI/todui-keymove").unwrap(),
        ...
        assert_eq!(
            normalize_repo("https://github.com/SakanaAI/todui-keymove.git").unwrap(),
            "sakanaai/todui-keymove"
        );
    }
    ...
    fn builds_canonical_github_repo_urls() {
        assert_eq!(
            github_repo_url("https://github.com/SakanaAI/todui-keymove").unwrap(),
            "https://github.com/sakanaai/todui-keymove"
        );
        assert_eq!(
            github_repo_url("@SakanaAI/todui-keymove").unwrap(),
            "https://github.com/sakanaai/todui-keymove"
        );
        assert_eq!(
            github_repo_url("SakanaAI/todui-keymove").unwrap(),
