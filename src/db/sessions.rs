...
mod tests {
    ...
    fn updates_and_clears_session_repo_with_new_revision() {
        ...
        let updated = database
            ...
            .expect("set repo");
        assert_eq!(updated.repo.as_deref(), Some("exampleorg/todui-keymove"));
        assert_eq!(updated.current_revision, 2);
    ...
    fn edits_session_name_slug_and_rewrites_all_todo_repos() {
        ...
        assert_eq!(inherited.repo.as_deref(), Some("exampleorg/todui-keymove"));
        assert_eq!(explicit.repo.as_deref(), Some("exampleorg/todui-keymove"));
    }
